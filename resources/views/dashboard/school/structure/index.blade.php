                ...
                <div class="card-body">
                    <form action="{{ route('school.structure.create') }}" method="GET">
                        ...
                        <div class="form-group
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Enter structure name">
                        ...
                        <div class="form-group
                            ...
                            <input type="text" name="level" class="form-control" placeholder="Enter structure level">
                            <span class="text-danger">{{ $errors->first('level') }}</span>
                        </div>
                        <div class="form-group
                            {{ $errors->has('order') ? 'has-error' : '' }}">
                            <label for="order">Order</label>
                            <input type="text" name="order" class="form-control" placeholder="Enter structure order">
                        ...
                        <div
                            ...
                            <input type="text" name="deleted_at" class="form-control" placeholder="Enter deleted at">
